...
abstract class question_definition {
    ...
    public function format_questiontext($qa) {
        if ($formattext = $this->format_text($this->questiontext,
                $this->questiontextformat, $qa, 'question', 'questiontext', $this->id)) {
    ...
    public function format_generalfeedback($qa) {
        if ($formatext = $this->format_text($this->generalfeedback, $this->generalfeedbackformat,
