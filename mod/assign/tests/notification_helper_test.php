...
final class notification_helper_test extends \advanced_testcase {
    ...
    public function test_send_notification_with_summary_to_user(): void {
        ...
        // HTML characters should be removed from the filename.
        $this->assertStringNotContainsString($filename3, $message->fullmessage);
        $this->assertStringContainsString('submissionsample.txt', $message->fullmessage);
