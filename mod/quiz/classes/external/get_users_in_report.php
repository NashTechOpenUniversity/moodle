...
class get_users_in_report extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'class' => new external_value(PARAM_TEXT, 'Class of table'),
     ...
     * @param string $class the table class.
     ...
     */
    public static function execute(int $cmid, string $mode, string $class,
        ...
        if ($class !== "") {
            ...
            $table = new $class($quiz, $context, $qmsubselect,
            ...
            $users = array_map(function ($user) use ($PAGE, $allowfields) {
