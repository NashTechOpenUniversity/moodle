...
class single_overallfeedback_form extends \moodleform {
    ...
    public function definition() {
        ...
        // Since we're only creating a new form element and appending it to the existing form,
        // it's unnecessary to notify a form change. Therefore, we will disable notifications here to
        // prevent any unexpected errors with watchForm.
