...
class single_overallfeedback_form extends \moodleform {
    ...
    public function definition() {
        ...
        // We need to create a unique ID for the text editor because it is necessary for the editor's JavaScript to set events based on that ID.
        // Since the ID of the editor is attached to JavaScript, we cannot change it.
        $mform->addElement('editor',
            'feedbacktext[' . $after . '_temporary_' . $order . '][text]', get_string('feedback', 'quiz'), ['rows' => 3, 'data-position' => $after],
