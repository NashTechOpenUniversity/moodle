        ...
        switch ($class) {
            case 'section':
                ...
                switch ($field) {
                    case 'getsectiontitle':
                        debugging('getsectiontitle is deprecated. Please use mod_quiz\external\get_section_title() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                        $result = ['instancesection' => $section->heading];
                        break;
                    case 'updatesectiontitle':
                        debugging('updatesectiontitle is deprecated. Please use mod_quiz\external\update_section_title() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                        $structure->set_section_heading($id, $newheading);
                        $result = ['instancesection' => format_string($newheading)];
                        break;
                    case 'updateshufflequestions':
                        debugging('updateshufflequestions is deprecated. Please use mod_quiz\external\update_shuffle_questions() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
            ...
            case 'resource':
                switch ($field) {
                    ...
                    case 'getmaxmark':
                        debugging('getmaxmark is deprecated. Please use mod_quiz\external\get_max_mark() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                    ...
                    case 'updatemaxmark':
                        debugging('updatemaxmark is deprecated. Please use mod_quiz\external\update_max_mark() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                    ...
                    case 'updatepagebreak':
                        debugging('updatepagebreak is deprecated. Please use mod_quiz\external\update_page_break() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                    ...
                    case 'deletemultiple':
                        debugging('deletemultiple is deprecated. Please use mod_quiz\external\delete_multiple() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                    ...
                    case 'updatedependency':
                        debugging('updatedependency is deprecated. Please use mod_quiz\external\update_question_dependency() instead.', DEBUG_DEVELOPER);
                        require_capability('mod/quiz:manage', $modcontext);
                        $slot = $structure->get_slot_by_id($id);
                        $value = (bool) $value;
