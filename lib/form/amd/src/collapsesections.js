...
export const init = collapsesections => {
    ...
    collapsemenu.addEventListener('click', () => {
        ...
        let formParent = collapsemenu.closest('form');
    ...
    $(SELECTORS.FORMCONTAINER).on('hidden.bs.collapse', (e) => {
        let allcollapsed = true;
        if (e.target.classList.contains(CLASSES.SHOW)) {
            allcollapsed = false;
        }
    ...
    $(SELECTORS.FORMCONTAINER).on('shown.bs.collapse', (e) => {
