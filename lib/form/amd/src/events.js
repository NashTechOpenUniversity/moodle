...
export const eventTypes = {
    ...
    /**
     * An event triggered when a changes of attachment area.
     *
     * @event notifyAttachmentChange
     * @type {CustomEvent}
     */
    notifyAttachmentChange: 'core_form/notifyAttachmentChange',
};
...
/**
 * Trigger an event to notify the changes in the attachment.
 *
 * @method
 * @param {String} elementId The element which was changed
 * @returns {CustomEvent}
 * @fires notifyAttachmentChange
 */
export const notifyAttachmentChange = elementId => {

    return dispatchEvent(
        eventTypes.notifyAttachmentChange,
        {},
        document.getElementById(elementId),
        {
            bubbles: true,
