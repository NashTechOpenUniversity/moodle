    ...
    Y.extend(FileManagerHelper, Y.Base, {
                ...
                dialogOptions.callback = function(params) {
                    this.request({
                        ...
                        callback: function(id, obj, args) {
                            ...
                            if (obj && obj.length) {
                                var actionfile = {action: 'delete'};
                                args.scope.refresh(obj[0], actionfile);
                            }
                            if (typeof M.core_formchangechecker != 'undefined') {
                                M.core_formchangechecker.set_form_changed();
                            }
        ...
        view_files: function(appendfiles, actionfiles) {
            ...
            if ((appendfiles == null) && (!this.options.list || this.options.list.length == 0) && this.viewmode != 2) {
                ...
                // This used to focus after refreshing the list files is empty by deletion file action.
                if (actionfiles !== undefined && actionfiles.action == 'delete') {
                    this.filemanager.one('.fp-btn-add a').setAttribute('tabIndex', '0');
            ...
            var options = {
                ...
                callback : function(e, node) {
                    ...
                    if (node.type == 'folder') {
                        ...
                        // This used to focus on file after dialogue closed.
                        var previousActiveElement = e.target.ancestor('a', true);
            ...
            this.content_scrolled();
            // This used to focus after refreshing the list files by update file and set main file action.
            if (actionfiles !== undefined) {
                ...
                if (actionfiles.action == 'delete') {
                    this.filemanager.one('.fp-btn-delete a').setAttribute('tabIndex', '0');
                ...
                dialog_options.callback = function(params) {
                    ...
                    this.request({
                        ...
                        callback: function(id, obj, args) {
                            ...
                            var actionfile = {action: 'delete'};
                            args.scope.refresh(obj.filepath, actionfile);
                            if (typeof M.core_formchangechecker != 'undefined') {
                                M.core_formchangechecker.set_form_changed();
                            }
                        }
        ...
        render: function(obj, action) {
            this.print_path();
            var appendfiles = null;
            this.view_files(appendfiles, action);
        },
