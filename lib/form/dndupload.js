...
M.form_dndupload.init = function(Y, options) {
    var dnduploadhelper = {
        ...
        init: function(Y, options) {
            ...
            // Initialise listener for events from editor (to show / hide the 'drop files here' message).
            document.addEventListener('dragEnterEditor', function(e) {
                e.preventDefault();
                this.pageentercount = 0;
                this.hide_drop_target();
            }.bind(this));
            document.addEventListener('dropInEditor', function(e) {
                e.preventDefault();
                this.pageentercount = 0;
                this.hide_drop_target();
            }.bind(this));
            document.addEventListener('dragLeaveEditor', function(e) {
                e.preventDefault();
