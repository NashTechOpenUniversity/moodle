...
Y.namespace('M.atto_recordrtc').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _audio: function() {
        ...
        // Require mediarecorder library.
        require(['atto_recordrtc/mediarecorder'], function(module) {
            window.mp3MediaRecorder = module.Mp3MediaRecorder;
            window.workerURL = module.workerURL;
        });
    ...
    ATTRS: {
        ...
        /**
         * Records the audio in MP3 format.
         *
         * @attribute audiortcmp3
         * @type Boolean
         * @default false
         */
        audiortcmp3: {
