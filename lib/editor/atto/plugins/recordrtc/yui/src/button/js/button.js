...
/** global: M */
var HELPTOOLTIP = '' +
    '<a class="btn btn-link pr-2 pl-2" role="button"' +
...
var PLUGINNAME = 'atto_recordrtc',
    ...
    '<div class="{{PLUGINNAME}} container-fluid">' +
      ...
      '<div class="{{bs_row}} hide">' +
        ...
        '<div class="{{bs_col}}3"></div>' +
      '</div>' +
      '<div class="{{bs_row}} {{PLUGINNAME}}_allow_download hide">' +
        '<div class="form-check">' +
            '<input type="checkbox" checked class="form-check-input mr-2"' +
            ' id="allow-download"/>' +
...
Y.namespace('M.atto_recordrtc').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    _createContent: function(type) {
        ...
        var bodyContent = Y.Handlebars.compile(TEMPLATE)({
            ...
            allowdownload: M.util.get_string('allowdownload', 'atto_recordrtc'),
            text: M.util.get_string('allowdownloadtext', 'atto_recordrtc'),
            helpicon: this.get('helpicon')
        });
    ...
    ATTRS: {
        ...
        /**
         * The helpicon to use when generating this recordrtc.
         *
         * @attribute helpicon
         * @type String
         */
