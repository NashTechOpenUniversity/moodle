...
M.atto_recordrtc.commonmodule = {
    ...
    create_annotation: function(type, recording_url) {
        ...
        html += cm.insert_download_link(type, recording_url);
        return html;
    },
    ...
    // Prepare download link of icon based on mimetype.
    insert_download_link: function(type, recording_url) {
        var downloadlink = document.createElement('a');
        var icon = document.createElement('img');
        downloadlink.setAttribute('href', recording_url);
        downloadlink.setAttribute('class', 'atto_recordrtc_download_' + type);
        downloadlink.setAttribute('download', '');
        downloadlink.appendChild(icon);

        icon.setAttribute('src', M.util.image_url('f/' + type, 'moodle'));
        icon.setAttribute('alt', M.util.get_string('downloadrtc', 'atto_recordrtc', type));
