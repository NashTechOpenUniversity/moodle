            ...
            if ($instances) {
                foreach ($instances as $cm) {
                    ...
                    if ($cm->id) {
                        ...
                        // We delete the questions after the activity database needed because
                        // The question may be used by activities in the course.
                        // So we want to make sure those questions are not used.
