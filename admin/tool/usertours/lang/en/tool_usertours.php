...
$string['filter_excludecategory'] = 'Exclude category';
$string['filter_excludecategory_help'] = 'Do not show the tour on pages associated with courses in the selected exclude category.';
$string['filter_excludecourse'] = 'Exclude courses';
$string['filter_excludecourse_help'] = 'Do not show the tour on pages associated with the selected exclude courses.';
